...
def run_farm_bot():
    ...
    while True:
        ...
        while True:
            ...
            loc_relay = locate_image_multiscale('public/assets/btn_relay.png', confidence=0.8, steps=15)
        ...
        has_error_connect = is_image_present('public/assets/btn_confirm.png', confidence=0.8)
        if has_error_connect:
